...
protocol FailableInsertFeedStoreSpecs {
    func test_insert_deliversErrorOnIsertionError()
    func test_insert_hasNoSideEffectsOnIsertionError()
}
...
class CodableFeedStoreTests: XCTestCase {
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected side-effects to run serially but the operations finished in wrong order")
    }
