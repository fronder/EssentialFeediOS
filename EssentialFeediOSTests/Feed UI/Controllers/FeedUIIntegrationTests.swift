...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.url, image1.url], "Expected two cancelled image URL requests once second image is alse not visible anymore")
    }
    ...
    func test_feedImageView_rendersImageLoadedFromURL() {
        ...
        XCTAssertEqual(view0?.renderedImage, imageData0, "Expected image for first view while loading first image")
        XCTAssertEqual(view1?.renderedImage, .none, "Expected no image for second view while loading second image")
    ...
    func test_loadImageDataCompletion_dispatchesFromBackgroundToMainThread() {
        ...
        let exp = expectation(description: "Wait for background queuework ")
        DispatchQueue.global().async {
